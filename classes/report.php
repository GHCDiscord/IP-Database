...
JOIN `Users` ON `IPUserReport`.`UserID` = `Users`.`ID`');
     ...
     while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
            ...
            $rowString = "<tr>
                ...
                <td> <a href='api/unreportip.php?id={$row["IPID"]}&uid={$row["UserID"]}' data-placement='top' data-toggle='tooltip' title='Delete'><button class='btn btn-warning btn-xs' ><span class='glyphicon glyphicon-trash'></span></button></a></td>
                </tr>";
